...
from openstl.modules import Attention, PreNorm, FeedForward, MultiScaleSpatialMixer
import math
...
class GatedTransformer(nn.Module):
    """Standard gated transformer: Attention + SwiGLU FFN, with DropPath.

    Used for temporal branches only in this variant.
    """

    def __init__(self, dim, depth, heads, dim_head, mlp_dim, dropout=0.,
                 attn_dropout=0., drop_path=0.1):
        super().__init__()
